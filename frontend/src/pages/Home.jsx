...
const selectStyles = {
  ...
  placeholder: (b) => ({ ...b, color: '#2e2e3a', fontSize: '0.9rem' }),
  input: (b) => ({ ...b, color: '#fff' }),
  indicatorSeparator: () => ({ display: 'none' }),
  dropdownIndicator: (b, s) => ({
    ...b, color: s.isFocused ? '#8b5cf6' : '#2e2e3a',
    transition: 'color 0.2s, transform 0.25s',
    transform: s.selectProps.menuIsOpen ? 'rotate(180deg)' : 'rotate(0deg)',
    paddingRight: '12px',
    '&:hover': { color: '#8b5cf6' },
  }),
  clearIndicator: (b) => ({ ...b, color: '#2e2e3a', '&:hover': { color: '#f87171' } }),
}
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ color: '#27272a', fontSize: '0.7rem', marginTop: '1px' }}>{city}</div>
      </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
          ...
          <span style={{ color: '#2e2e3a', fontSize: '0.65rem', fontFamily: 'JetBrains Mono, monospace', letterSpacing: '1px' }}>LIVE SCAN</span>
        </div>
      </div>
      ...
      <div style={{
        ...
        <span style={{ color: '#27272a', fontSize: '0.65rem', fontFamily: 'JetBrains Mono, monospace' }}>
    ...
    <div style={{ minHeight: '100vh', background: '#09090f', color: '#fff', fontFamily: "'Outfit', sans-serif" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
          <button className="ghost-btn" style={{ padding: '8px 20px', fontSize: '0.82rem', borderRadius: '8px' }}>Log in</button>
      ...
      <section style={{
        ...
        <div>
          ...
          <p className="f3" style={{
            color: '#3f3f46', fontSize: '1rem', lineHeight: 1.8,
          ...
          <div className="f5" style={{ display: 'flex', gap: '32px' }}>
            {[['124k+','Businesses indexed'],['89k+','Without websites'],['420+','Cities covered']].map(([val, label]) => (
              <div key={label}>
                ...
                <div style={{ fontSize: '0.7rem', color: '#27272a', textTransform: 'uppercase', letterSpacing: '1.5px', marginTop: '4px' }}>{label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="f6" style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.68rem', color: '#3f3f46', fontFamily: 'JetBrains Mono, monospace', letterSpacing: '1.5px', textTransform: 'uppercase', marginBottom: '16px' }}>
              Find leads
            </div>
      ...
      <section style={{ position: 'relative', zIndex: 1, padding: '120px 52px', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ marginBottom: '64px' }}>
          <div style={{ fontSize: '0.68rem', color: '#3f3f46', fontFamily: 'JetBrains Mono, monospace', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '16px' }}>How it works</div>
          ...
          {STEPS.map((s) => {
            ...
            return (
              <div key={s.step} className="step-card">
                ...
                <div style={{ color: '#27272a', fontSize: '0.82rem', lineHeight: 1.7 }}>{s.desc}</div>
              </div>
            )
          })}
        </div>
      ...
      <section style={{ position: 'relative', zIndex: 1, padding: '120px 52px', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ marginBottom: '64px' }}>
          <div style={{ fontSize: '0.68rem', color: '#3f3f46', fontFamily: 'JetBrains Mono, monospace', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '16px' }}>Features</div>
          <h2 style={{ fontSize: 'clamp(2rem, 3.5vw, 3rem)', fontWeight: '800', letterSpacing: '-2px', color: '#fafafa' }}>
          ...
          {FEATURES.map(f => {
            ...
            return (
              <div key={f.title} className="feat-card">
                ...
                <div style={{ color: '#3f3f46', fontSize: '0.85rem', lineHeight: 1.7 }}>{f.desc}</div>
              </div>
            )
          })}
        </div>
      ...
      <section style={{
        ...
        <div style={{ fontSize: '0.68rem', color: '#3f3f46', fontFamily: 'JetBrains Mono, monospace', letterSpacing: '2px', textTransform: 'uppercase', marginBottom: '20px' }}>
          Get started today
        </div>
        ...
        <p style={{ color: '#3f3f46', fontSize: '1rem', marginBottom: '44px' }}>
